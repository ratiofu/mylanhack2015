...
module.exports = {
  generateTaskEvents: generateTaskEvents
}

var taskEventListener = {
...
// test
generateTaskEvents(taskEventListener, path, 1001);

function generateTaskEvents(listener, rootPath, spaceId) {
